...
@section('content')
    <div
                            ...
                            <div class="bg-white p-6 rounded-md shadow-md mb-4">
                                ...
                                <div class="relative h-0 overflow-hidden rounded-lg" style="padding-bottom: 100%;">
                                    <img src="{{ asset('storage/' . $product->photo) }}"
                                        alt=""class="absolute top-0 left-0 w-full h-full object-contain">
                                </div>
                                ...
                                <div class="flex justify-between mt-2">
                                    ...
                                    <form action="{{ route('admindelete_products', $product) }}" method="POST"
                                        class="inline">
                                        @method('delete')
                                        @csrf
        ...
        <div class="mt-4">
            ...
            <form action="{{ route('admincreate_products') }}" method="GET" class=" mt-4">
