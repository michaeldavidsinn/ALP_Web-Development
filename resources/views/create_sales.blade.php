    ...
    @endif
        <div class="flex items-center justify-center h-auto">
            <div class="max-w-md mx-auto bg-white p-8 rounded-md shadow-md">
                <h2 class="text-2xl font-bold mb-6">Tambah Sales</h2>

                <form action="{{ route('adminstore_sales') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="w-full p-2 border border-gray-300 rounded-md" id="sales_name"
                            name="sales_name" placeholder="Sales Name"required>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="w-full p-2 border border-gray-300 rounded-md" id="sales_contact"
                            name="sales_contact" placeholder="Sales Contact"required>
                    </div>
