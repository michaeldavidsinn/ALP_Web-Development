...
@section('content')
    <div
        ...
        <div class="container mx-auto">
                                    ...
                                    @foreach ($storess as $store)
                                        <tr>
                                            <td class="py-4 px-4"><a href="/store/{{ $store['id'] }}"
                                                    class="text-blue-500 hover:underline">{{ $store['store_name'] }}</a>
                                            </td>
                                            ...
                                            <td class="py-2 px-4">
                                                ...
                                                <form action="{{ route('admindelete_store', $store) }}" method="POST"
                                                    class="inline">
                                                    @method('delete')
                                                    @csrf
            ...
            <form action="{{ route('admincreate_store') }}" method="GET" class="">
