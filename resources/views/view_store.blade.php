...
<div class="container mx-auto mt-8">
    <div class="bg-white p-6 rounded-md shadow-md">
        ...
        <form action="{{ route('create_store')}}" method="GET" class="mb-4">
            <div class="flex items-center">
                <button class="bg-blue-500 text-white px-4 py-2 rounded-md" href="{{ route('create_store')}}">Create</button>
            </div>
        </form>
                ...
                <tbody>
                    ...
                    @foreach ($storess as $store)
                        <tr>
                            ...
                            <td class="py-2 px-4">
                                <a href="{{route('edit_store', $store)}}" class="text-blue-500 hover:underline">Edit</a>

                                <form action="{{route('delete_store', $store)}}" method="POST" class="inline">
                                    @method('delete')
                                    @csrf
