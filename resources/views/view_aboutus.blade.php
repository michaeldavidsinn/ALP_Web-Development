...
@section('content')
    ...
    <div class="container mx-auto px-8 mb-8">
        ...
        <h1 class="p-2 font-bold text-3xl text-center my-8">Sales Kami</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4">
            @foreach ($dataSales as $dataSaless)
                <div class="bg-white p-20 rounded-md shadow-md">
        ...
        <div>
            <h1 class="text-3xl font-bold mb-8 mt-8 text-center">Cabang Toko Kami</h1>
                        ...
                        @foreach ($dataStore as $dataStores)
                            <tr>
                                <td class="py-2 px-4"><a
                                        class="text-blue-500 hover:underline">{{ $dataStores['store_name'] }}</a></td>
                                <td class="py-2 px-4">{{ $dataStores['location'] }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
