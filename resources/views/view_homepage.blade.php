...
@section('content')
    ...
    <div
        ...
        <div>
            ...
            <div class="py-8">
                <h1 class=" text-white text-3xl font-bold text-center">Kunjungi Kami</h1>
                <h1 class=" text-white text-3xl font-bold text-center">PT.Mandiri Langgeng Perkasa</h1>
                <h1 class=" text-white text-3xl text-center">Jln. Ruhui rahayu no 88 b</h1>
                <h1 class=" text-white text-3xl text-center">Bergerak di bidang distribusi keramik dan sanitaire</h1>
                <h1 class=" text-white text-3xl text-center">Sebagai Distributor ceramic tile granit tile dan sanitaire merek KIA untuk wilayah kalimantan timur</h1>
                        ...
                        @foreach ($dataArticle as $dataArticles)
                            <div class="bg-white p-6 rounded-md shadow-md ">
                                ...
                                <div class="flex items-center justify-center my-8"> <!-- Menambah kelas items-center -->
                                    <a class="bg-blue-100 text-blue-500 px-4 py-2 rounded-md" href="/view_article">See More</a>
                                </div>
                            </div>
                        @endforeach
